...
function Customize(props) {
  ...
  return (
    ...
    >
      ...
      <h1 style={{ marginLeft: "10%", fontSize: "2.8rem" }}>Customize 🎨</h1>
      ...
      >
        <Picker color={color1} setColor={setColor1} text={"Color 1: "} />
        <Picker color={color2} setColor={setColor2} text={"Color 2: "} />
      </div>
      <div
        style={{ display: "inline-block", width: "20%", fontWeight: "bold" }}
      >
        <Picker color={color3} setColor={setColor3} text={"Color 3: "} />
        <Picker color={color4} setColor={setColor4} text={"Color 4:"} />
      </div>
      <Canvas
        className="preview"
