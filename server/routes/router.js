...
router
    .route('/:username/carousel')
    .get(carousel);
router
    .route('/:username/modal/:playlist')
    .get(modal);
router
    .route('/create-user')
    .post(createUser);
router
    ...
    .post(saveTrack);
router
    .route('/:username/removeSavedTrack')
    .post(removeSavedTrack);
router
    .route('/:username/wallOfMusic')
    .get(wallOfMusic);
router
    .route('/:username/savePlaylist')
    .post(savePlaylist);
router
    .route('/:username/playlistSaveStatus')
    .post(playlistSaveStatus);
router
    .route('/:username/removeSavedPlaylist')
    .post(removeFromSavedPlaylists);
router
    .route('/:username/setPlaylistSaveStatus')
    .post(setPlaylistSaveStatus);
router
    .route('/:username/listSavedPlaylists')
    .get(savedPlaylists);
router
    .route('/:username/getRecommendations')
    .get(displayRecommendedTracks);
router
    .route('/getSimilarTracks')
    .post(recommendTrack);
router
    .route('/:username/saveForLater')
    .post(savedForLater);
router
    .route('/:username/authenticateWithSpotify')
    .get(userSpotifyAuth);
router
    .route('/callback')
    .get(spotifyAuthUser);
...
router
    .route('/:username/addToMyLibrary')
    .get(addToLibrary);
router
    .route('/:username/addToUserPlaylist')
    .post(addTrackToPlaylist);
router
    .route('/:username/explicit')
    .post(explicitStatus);